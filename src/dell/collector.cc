...
static const char* ncclOpToString(ncclRedOp_t op) {
  switch (op) {
    case ncclSum:
      return "ncclSum";
    case ncclProd:
...
static const char* ncclDatatypeToString(ncclDataType_t type) {
  switch (type) {
...
static const char* ncclAlgoToString(int algo) {
  switch (algo) {
    case NCCL_ALGO_TREE:
      return "TREE";
    case NCCL_ALGO_RING:
...
static const char* ncclProtoToString(int proto) {
  switch (proto) {
    case NCCL_PROTO_LL:
      return "LL";
